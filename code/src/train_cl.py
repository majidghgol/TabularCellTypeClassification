...
if __name__ == '__main__':
    ...
    for fi, fold in enumerate(folds):
        ...
        # ce_model.load_state_dict(torch.load(out_path+f'/ce_fold{fi}.model', map_location=device))
        # fe_model.load_state_dict(torch.load(out_path+f'/fe_fold{fi}.model', map_location=device))
        # cl_model.load_state_dict(torch.load(out_path+f'/cl_fold{fi}.model', map_location=device))
        # with torch.no_grad():
        #     test_gt = []
        #     test_pred = []
        ...
        #         test_gt += labels
        #         # print(labels, len(labels), pred.shape)
